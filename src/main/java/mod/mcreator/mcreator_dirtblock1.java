...
public class mcreator_dirtblock1 {

	public static Object instance;
	public static Block block;
	static {
		block = new BlockCustom().setHardness(2.25F).setResistance(7.5F).setLightLevel(0F).setUnlocalizedName("dirtblock1").setLightOpacity(255)
				.setCreativeTab(mcreator_blocktab0w.tab);
	}

	public void preInit(FMLPreInitializationEvent event) {
		block.setHarvestLevel("shovel", 0);
		block.setRegistryName("dirtblock1");
	...
	public void load(FMLInitializationEvent event) {
		if (event.getSide() == Side.CLIENT) {
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(Item.getItemFromBlock(block), 0, new ModelResourceLocation("testenvironmentmod:dirtblock1", "inventory"));
		}
	}
