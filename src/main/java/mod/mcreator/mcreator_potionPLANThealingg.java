...
public class mcreator_potionPLANThealingg {

	public static Object instance;
	public static Block block;
	static {
		block = (Block) (new BlockCustomFlower()).setHardness(0.01F).setResistance(2F).setLightLevel(0.16F).setUnlocalizedName("potionplanthealingg");
	}

	public void preInit(FMLPreInitializationEvent event) {
		block.setRegistryName("potionplanthealingg");
	...
	public void load(FMLInitializationEvent event) {
		if (event.getSide() == Side.CLIENT) {
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(Item.getItemFromBlock(block), 0, new ModelResourceLocation("testenvironmentmod:potionplanthealingg", "inventory"));
		}
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public BlockCustomFlower() {
			...
			this.setCreativeTab(mcreator_aNOTHERR.tab);
		}
