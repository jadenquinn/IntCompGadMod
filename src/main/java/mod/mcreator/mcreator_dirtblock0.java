...
public class mcreator_dirtblock0 {

	public static Object instance;
	public static Block block;
	static {
		block = new BlockCustom().setHardness(1.55F).setResistance(11F).setLightLevel(0F).setUnlocalizedName("dirtblock0").setLightOpacity(255)
				.setCreativeTab(mcreator_blocktab0w.tab);
	}

	public void preInit(FMLPreInitializationEvent event) {
		block.setHarvestLevel("shovel", 0);
		block.setRegistryName("dirtblock0");
	...
	public void load(FMLInitializationEvent event) {
		if (event.getSide() == Side.CLIENT) {
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(Item.getItemFromBlock(block), 0, new ModelResourceLocation("testenvironmentmod:dirtblock0", "inventory"));
		}
	}
