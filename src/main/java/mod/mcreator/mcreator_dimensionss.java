...
public class mcreator_dimensionss {
	...
	static {
		portal = (BlockCustomPortal) (new BlockCustomPortal().setUnlocalizedName("dimensionss_portal"));
		block = (ModTrigger) (new ModTrigger().setUnlocalizedName("dimensionss_trigger"));
	}

	public void load(FMLInitializationEvent event) {
		if (event.getSide() == Side.CLIENT) {
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(block, 0, new ModelResourceLocation("testenvironmentmod:dimensionss_trigger", "inventory"));
		}
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		portal.setRegistryName("dimensionss_portal");
		...
		block.setRegistryName("dimensionss_trigger");
		ForgeRegistries.ITEMS.register(block);
		dtype = DimensionType.register("dimensionss", "_dimensionss", DIMID, WorldProviderMod.class, true);
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				mcreator_dropBlockdiamond0.executeProcedure($_dependencies);
			}
		}
				...
				for (int j1 = -2; j1 <= 2; ++j1) {
					for (int k1 = -2; k1 <= 2; ++k1) {
						for (int l1 = -1; l1 < 3; ++l1) {
							...
							int k2 = k - j1;
							boolean flag = l1 < 0;
							this.world.setBlockState(new BlockPos(i2, j2, k2), flag ? Blocks.SAND.getStateFromMeta(1) : Blocks.AIR.getDefaultState());
						}
					}
				}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? Blocks.SAND.getStateFromMeta(1) : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
			...
			for (int i8 = 0; i8 < 4; ++i8) {
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12), flag1 ? Blocks.SAND.getStateFromMeta(1) : iblockstate, 2);
					}
				}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != Blocks.SAND.getStateFromMeta(1).getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == Blocks.SAND.getStateFromMeta(1).getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.SAND.getStateFromMeta(1).getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.SAND
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("plains")),
				...
				Biome.REGISTRY.getObject(new ResourceLocation("swampland")), Biome.REGISTRY.getObject(new ResourceLocation("hell")),
				Biome.REGISTRY.getObject(new ResourceLocation("river")), Biome.REGISTRY.getObject(new ResourceLocation("sky")),
				Biome.REGISTRY.getObject(new ResourceLocation("beaches")), Biome.REGISTRY.getObject(new ResourceLocation("jungle_edge")),};
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		protected static final IBlockState STONE = Blocks.GRASS.getDefaultState();
		...
		protected static final IBlockState SOUL_SAND = Blocks.BRICK_BLOCK.getDefaultState();
		private final WorldGenerator quartzGen = new WorldGenMinable(Blocks.EMERALD_ORE.getDefaultState(), 14,
